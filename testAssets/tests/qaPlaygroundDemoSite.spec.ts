...
test.describe("QA Playground Full Automation Sequence", () => {
  ...
  test.describe("Shadow DOM & Rating Slider", () => {
    test("TC26: Click Boost button in Shadow DOM", async ({
      shadowDomPage,
    }) => {
    ...
    test("TC27: Move slider and verify feedback", async ({
      ratingSliderPage,
    }) => {
  ...
  test.describe("Sortable List", () => {
    test("TC28: Arrange items and verify correct order", async ({
      sortableListPage,
    }) => {
  ...
  test.describe("Redirect Chain, Context Menu & Fetching Data", () => {
    test("TC29: Verify Redirect Chain and Go Back button", async ({
      redirectPage,
    }) => {
    ...
    test("TC30: Right-click context menu and verify items", async ({
      rightClickPage,
    }) => {
    ...
    test("TC31: Verify 100 cards loaded with headers and body", async ({
      fetchingDataPage,
    }) => {
  ...
  test.describe("Stars Rating Widget", () => {
    test("TC32: Click each star and verify emoji", async ({
      starsRatingPage,
    }) => {
...
test.describe("Covered Elements", () => {
  test("TC33: Click covered button and verify success", async ({
    coveredElementsPage,
  }) => {
